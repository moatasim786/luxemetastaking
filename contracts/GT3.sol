...
contract LuxeRacingGT3 is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
  ...
  constructor() ERC721("LuxeRacingNFT GT3", "LUXEGT3") {
    sender = msg.sender;
  }

  function _baseURI() internal pure override returns (string memory) {
    return
      "https://gateway.pinata.cloud/ipfs/QmTuVLPBepiDiuysMihvCNeHiV51MtXpxvzYb8kMDwS2nG/";
  }
